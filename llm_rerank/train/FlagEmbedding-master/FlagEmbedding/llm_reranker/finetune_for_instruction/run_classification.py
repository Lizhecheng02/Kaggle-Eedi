...
from load_model import get_class_model
import wandb
...
def main():
    ...
    # wandb.init(project="Eedi", config=training_args)
    # wandb.save('/home/chenning/code/Eedi/llm_rerank/train/')
    ...
    num_labels = 1
    model = get_class_model(model_args, training_args)
